...
#reload(MMUTILS)
from cgm.core.mrs.lib import ui_utils as MRSUI
...
def buildFrame_mrsList(self,parent):
    ...
    _scrollList = MRSUI.mrsScrollList(_inside, ut='cgmUISubTemplate',
...
def mmUI_controls(self,parent = None):
    ...
    for m in ['Add to selection','Select Only','Push','Pull','SymLeft','SymRight','Flip']:
        ...
        mc.menuItem(p=_mirror,l=m,
                    c=lambda *a:uiCB_contextualActionMM(self, **_d_tmp))
    return
    ...
    for n in l_settings + l_enums:
        ...
        for v,o in enumerate(l_options):
            mc.menuItem(p=_sub,l=o,
                        c=lambda *a:uiCB_contextSetValue(self,n,v,_mode,**_d_tmp))
        """
        if n in l_settings:
            l_options = ['hide','show']
            _mode = 'moduleSettings'
...
def mmUI_part(self,parent = None):
    ...
    for n in l_settings:
        ...
        for v,o in enumerate(['hide','show']):
            mc.menuItem(p=_sub,l=o,
                        c=lambda *a:uiCB_contextSetValue(self,n,v,'moduleSettings',**_d_tmp))
