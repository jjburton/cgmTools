...
@cgmGEN.Timer
def uiMenu_changeSpace(self, parent, showNoSel = False, d_timeContext = {}):
            ...
            for atr in d_sharedAttrsDat.keys():
                ...
                for i,o in enumerate(d_sharedAttrsDat.get(atr)):
                    mc.menuItem(p=tmpMenu,l = "%s"%o,
                                c = lambda *a:func_process(self.md_spaceSwitchDat,atr,o, d_timeContext))
                    ...
                    if mObj.hasAttr(a):
                        ...
                        for i,o in enumerate(ATTR.get_enumList(_short,a)):#enumerate(cgmMeta.cgmAttr(mObj.mNode,a).p_enum)
                            ...
                            mc.menuItem(p=tmpMenu,l = o,en = True,
                                        c = lambda *a:func_process(self.md_spaceSwitchDat,a,i, d_timeContext))
...
def uiMenu_changeSpaceOverTime(self, parent, showNoSel = False):
