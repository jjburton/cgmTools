...
{'bounce': {'dag': {'orient': [-20.57745119169334,
 ...
 'sun': {'dag': {'orient': [-2.765755479863683,
         ...
         'type': 'directionalLight'}}
,
              'day':{'bounce': {'dag': {'orient': [-50.790339932004514,
                                61.39775899390578,
                                -145.465492014801],
                     'position': [1.4648982207936525,
                                  -43.32562782559744,
                                  -9.984264326198579]},
             'settings': {'color': (1.774399995803833,
                                    2.207200050354004,
                                    1.9686000347137451),
                          'emitDiffuse': True,
                          'emitSpecular': False,
             ...
             'type': 'directionalLight'},
 'fill': {'dag': {'orient': [-34.50958470232005,
                              -15.976253843061599,
                              -33.68271778286914],
                   'position': [-28.280156654023763,
                                17.069636406353993,
                                -24.372186965235645]},
           'settings': {'color': (0.8756999969482422,
                                  0.949999988079071,
                                  1.0),
                        'emitDiffuse': True,
                        'emitSpecular': False,
                        'intensity': 0.5948193669319153},
           'type': 'directionalLight'},
 'key': {'dag': {'orient': [-76.30378187741512,
                             -6.402653047215821,
                             -70.49173422790992],
                  'position': [-1.2061882796113137,
                               18.451320682141777,
                               40.60969488931725]},
          'settings': {'color': (0.5098000168800354, 0.737500011920929, 1.0),
                       'emitDiffuse': True,
                       'emitSpecular': False,
                       'intensity': 1.0481927394866943},
          'type': 'directionalLight'},
 'sun': {'dag': {'orient': [407.8137472865702,
                             -77.49988293994107,
                             -135.4740552040945],
                  'position': [38.30152355716236,
                               19.42306755249934,
                               -11.6051379770363]},
          'settings': {'color': (1.0, 1.0, 1.0),
                       'emitDiffuse': True,
                       'emitSpecular': True,
                       'intensity': 1.9500000476837158},
          'type': 'directionalLight'}},
              'dawn':{'backLeft': {'dag': {'orient': [-152.3746479778147,
                                 8.157983893551844,
                                 80.70820147099408],
                      'position': [-28.338548376048074,
                                   16.192358014296754,
                                   -24.897338467492375]},
              'settings': {'color': (0.9606999754905701,
                           ...
                           'emitDiffuse': True,
                           'emitSpecular': False,
                           'intensity': 0.8433734774589539},
              'type': 'directionalLight'},
 'bounce': {'dag': {'orient': [22.11429653785688,
                               63.98873423967353,
                               -72.11150724965755],
                    'position': [9.228640525262607,
                                 -40.99346177253459,
                                 -6.910918015194629]},
            'settings': {'color': (0.5450999736785889,
                                   1.0111000537872314,
                                   1.3899999856948853),
                         'emitDiffuse': True,
                         'emitSpecular': False,
            ...
            'type': 'directionalLight'},
 'fill': {'dag': {'orient': [43.16860726646139,
                             3.7629878021716032,
                             -111.03724642613987],
                  'position': [1.3664688323669125,
                               -43.670765737584794,
                               -8.362922350352642]},
          'settings': {'color': (0.6299999952316284,
                                 0.5108000040054321,
                                 0.8626999855041504),
                       'emitDiffuse': True,
                       'emitSpecular': False,
                       'intensity': 0.3800000250339508},
          'type': 'directionalLight'},
 'key': {'dag': {'orient': [-59.33127332193391,
                            -5.696078223424616,
                            -95.62793259962207],
                 'position': [-1.0392035786949259,
                              19.95789079469692,
                              39.895564854172996]},
         'settings': {'color': (0.8431000113487244, 0.9509000182151794, 1.0),
                      'emitDiffuse': True,
                      'emitSpecular': False,
                      'intensity': 0.5},
         'type': 'directionalLight'},
 'sun': {'dag': {'orient': [75.79779385010536,
                            -5.694830957850268,
                            93.4806423841861],
                 'position': [38.29006140291814,
                              18.914274339271135,
                              -12.452425924068526]},
         'settings': {'color': (1.0,
                                0.49309998750686646,
