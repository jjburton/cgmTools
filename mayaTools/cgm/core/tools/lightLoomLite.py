...
d_profiles = {'modeling2':{'back_right': {'dag': {'orient': [149.8269192017149,
                          ...
                          'key': {'dag': {'orient': [-39.599421538287224,
                                           ...
                                           'type': 'directionalLight'}},
              'movieScene1':{'backRight_cgmLight': {'dag': {'orient': [146.77940085820202,
                                                                    2.0469790117186126,
                                                                    86.49572766778664],
                                                 ...
                                                 'type': 'directionalLight'},
                          'back_left_cgmLight': {'dag': {'orient': [-202.81024395740735,
                                                                    44.6908793647225,
                                                                    -53.88133602325775],
                                                         'position': [0.0, 0.0, 0.0]},
                                                 'settings': {'color': (0.0,
                                                 ...
                                                 'type': 'directionalLight'},
                          'bottom_cgmLight': {'dag': {'orient': [-103.73011291056315,
                                                                 72.95907099439766,
                                                                 146.0722843835733],
                                                      'position': [0.0, 0.0, 0.0]},
                                              ...
                                              'type': 'directionalLight'},
                          'key_cgmLight': {'dag': {'orient': [-35.88326162597935,
                                                              -32.274268436094296,
                                                              -71.23384855747163],
                                                   'position': [0.0, 0.0, 0.0]},
                                           'settings': {'color': (1.0,
                                                                  0.7764000296592712,
                                                                  0.4900999963283539),
                                                        'intensity': 0.42168673872947693},
                                           'type': 'directionalLight'}},
              'modeling1':{'backRight_cgmLight': {'dag': {'orient': [147.0042449748957,
                                           -14.144818362556286,
                                           100.85568782885981],
                                'position': [36.40866110593307,
                                             13.542642206928516,
                                             -21.678277743937624]},
                        'settings': {'color': (1.100000023841858,
                                               0.7000000476837158,
                        ...
                        'type': 'directionalLight'},
                           'back_cgmLight': {'dag': {'orient': [-157.87591937848973,
                                                                -0.962704259809025,
                                                                -5.972660653610452],
                                                     'position': [1.7472384135375711,
                                                                  18.347357622514963,
                                                                  -16.744345913746162]},
                                             'settings': {'color': (1.0,
                                                                    0.8830000162124634,
                                                          ...
                                                          'intensity': 0.0},
                                             'type': 'directionalLight'},
                           'back_left_cgmLight': {'dag': {'orient': [-146.88676846695606,
                                                                     23.754910970003053,
                                                                     80.67419186212024],
                                                          'position': [-31.31872415840004,
                                                                       10.72781077943675,
                                                                       -24.273335944206416]},
                                                  'settings': {'color': (0.0, 0.559499979019165, 7.0),
                                                               'intensity': 5.542168617248535},
                                                  'type': 'directionalLight'},
                           'bottom_cgmLight': {'dag': {'orient': [-19.51510956542299,
                                                                  74.16477555403374,
                                                                  227.91717380444123],
                                                       'position': [-0.2095263272103779,
                                                                    -44.39670011014,
                                                                    2.7983219013132183]},
                                               ...
                                               'type': 'directionalLight'},
                           'key_cgmLight': {'dag': {'orient': [-41.80562790607786,
                                                               -53.75502268415159,
                                                               -67.11976224181153],
                                                    'position': [4.615843681290563,
                                                                 29.260152393667315,
                                                                 33.37050963191601]},
                                            'settings': {'color': (1.0, 1.0, 1.0), 'intensity': 1.5},
                                            'type': 'directionalLight'}},
              'fireSide':{'fill': {'dag': {'orient': [-525.2780421629645,
                          ...
                          'key': {'dag': {'orient': [-176.7546664004424,
                                  ...
                                  'settings': {'color': (0.0,
                                               ...
                                               'intensity': 1.5},
                                  'type': 'directionalLight'}},
              'night':{'bounce_cgmLight': {'dag': {'orient': [94.01106197507976,
                                        126.51264664976568,
                                        1.4609494202565856],
                             'position': [-0.13497421158596587,
                                          -43.69934200363868,
                                          -8.3241082300806]},
                     'settings': {'color': (0.2071000039577484,
                                            0.2071000039577484,
                                            0.2071000039577484),
                                  'intensity': 1.0240963697433472},
                     'type': 'directionalLight'},
                    'fill_cgmLight': {'dag': {'orient': [77.33846563804357,
                                                         -67.00809775929461,
                                                         -218.63867743185583],
                                              'position': [-32.297108888435936,
                                                           16.125943020886567,
                                                           -19.544665871415766]},
                                      'settings': {'color': (0.19599999487400055,
                                                             0.33320000767707825,
                                                             1.0),
                                                   'intensity': 2.7710843086242676},
                                      'type': 'directionalLight'},
                    'key_cgmLight': {'dag': {'orient': [87.7351452615586,
                                                        -64.14491046657037,
                                                        -127.53958355986153],
                                             'position': [6.037035308332071,
                                                          20.09200692127208,
                                                          39.381707767008415]},
                                     'settings': {'color': (0.3255000114440918,
                                                            0.3718000054359436,
                                                            0.9409999847412109),
                                                  'intensity': 1.0240963697433472},
                                     'type': 'directionalLight'},
                    'moon_cgmLight': {'dag': {'orient': [-126.1555101162294,
                                                         -24.269563926953648,
                                                         72.83168443476099],
                                              'position': [35.48222139853615,
                                                           18.849415633646117,
                                                           -19.095889146886744]},
                                      'settings': {'color': (0.980400025844574,
                                                             1.0,
                                                             0.3921000063419342),
                                                   'intensity': 1.3855421543121338},
                                      'type': 'directionalLight'}},
