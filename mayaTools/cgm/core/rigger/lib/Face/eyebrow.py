...
def build_shapes(self):
	...
	log.error("eyebrow.build_rig>>bad self!")
	raise StandardError,error
    ...
    try:
	#Rest of it
	l_toBuild = ['eyebrowIK','eyebrowFK','eyebrowSettings']
	mShapeCast.go(self._i_module,l_toBuild, storageInstance=self)#This will store controls to a dict called    
	#self._i_rigNull.connectChildNode(self._md_controlShapes['eyebrow'],'shape_eyebrow',"rigNull")
	
    except StandardError,error:
	log.error("build_eyebrow>>Build shapes fail!")
	raise StandardError,error 
    return True
...
def build_controls(self):
    ...
    mi_fkShape = cgmMeta.validateObjArg(self._i_rigNull.getMessage('shape_eyebrowFK'),cgmMeta.cgmObject) 
    mi_ikShape = cgmMeta.validateObjArg(self._i_rigNull.getMessage('shape_eyebrowIK'),cgmMeta.cgmObject) 
