...
#         
#         temp="c:/output.wav"  # need to figure where this should go
#         if not filepath:
#             scenepath=cmds.file(q=True, sn=True)
#             if scenepath:
#                 filepath='%s.wav' % os.path.splitext(scenepath)[0]
#             else:
#                 filepath=temp
...
#             
#         duration = ((frmrange[1] + abs(neg_adjustment) ) / getCurrentFPS()) * 1000
...
#             baseTrack = baseTrack.overlay(sound, position=(insertFrame / getCurrentFPS()) * 1000)
# 
...
#     @property
#     def startTime(self):
#         return (self.startFrame / getCurrentFPS()) * 1000
#     
#     @property
#     def endTime(self):
#         return (self.endFrame / getCurrentFPS()) * 1000
#            
#     def delete(self):
