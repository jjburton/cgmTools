...
//Last modified: Sun, Nov 25, 2012 08:44:17 PM
//Codeset: 1252
requires maya "2012";
...
createNode joint -n "Character1_LeftUpLeg" -p "Character1_Hips";
	...
	setAttr ".r" -type "double3" 0.0014316932029040793 1.6320608787711168 0.10152829426899776 ;
	setAttr ".s" -type "double3" 0.99999976158142079 0.99999976158142079 0.99999976158142079 ;
	setAttr ".sd" 1;
	setAttr ".typ" 2;
	setAttr ".radi" 3;
createNode joint -n "Character1_LeftLeg" -p "Character1_LeftUpLeg";
	...
	setAttr ".r" -type "double3" 7.4833436227696044 0 0 ;
	setAttr ".s" -type "double3" 0.99999976158142079 0.99999976158142079 0.99999976158142079 ;
...
createNode orientConstraint -n "Character1_LeftFoot_orientConstraint1" -p "Character1_LeftFoot";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".lr" -type "double3" -5.4031812979857063 -1.6313793310189943 0.11194991647738609 ;
...
createNode joint -n "Character1_RightUpLeg" -p "Character1_Hips";
	...
	setAttr -k off -cb on ".v";
	setAttr ".t" -type "double3" -8.9100029253966628 -6.2700057673468024 0 ;
	setAttr ".r" -type "double3" 0.00092998674764370513 -1.3192187539438076 -0.08204339391062597 ;
	setAttr ".s" -type "double3" 0.99999976158142079 0.99999976158142079 0.99999976158142079 ;
	setAttr ".sd" 2;
	setAttr ".typ" 2;
	setAttr ".radi" 3;
createNode joint -n "Character1_RightLeg" -p "Character1_RightUpLeg";
	...
	setAttr ".r" -type "double3" 7.4833463438183374 4.4598967548131653e-006 -1.8266585382215741e-005 ;
	setAttr ".s" -type "double3" 0.99999976158142079 0.99999976158142079 0.99999976158142079 ;
...
createNode joint -n "Character1_RightToeBase" -p "Character1_RightFoot";
	...
	setAttr ".s" -type "double3" 0.99999976158142079 0.99999976158142079 0.99999976158142079 ;
	setAttr ".jo" -type "double3" 0 1.46228119730024e-006 0 ;
	setAttr ".sd" 2;
	setAttr ".typ" 5;
	setAttr ".radi" 3;
createNode orientConstraint -n "Character1_RightFoot_orientConstraint1" -p "Character1_RightFoot";
	...
	setAttr -k off ".sz";
	setAttr ".erp" yes;
	setAttr ".lr" -type "double3" -5.4026314349323359 1.3186638081452791 -0.090479203586877111 ;
	setAttr ".rsrr" -type "double3" -9.0877809608762981 0 0 ;
	setAttr -k on ".w0";
...
createNode joint -n "Character1_RightHand" -p "Character1_RightForeArm";
	...
	setAttr ".s" -type "double3" 0.99999976158142079 0.99999976158142112 0.99999976158142079 ;
	setAttr ".pa" -type "double3" 8.2053358327015324 -20.864854833087477 -1.4328496998634295 ;
	setAttr ".sd" 2;
	setAttr ".typ" 12;
	setAttr ".radi" 3;
...
createNode hyperView -n "hyperView1";
	setAttr ".vl" -type "double2" -2088.6843816024702 -42914.285714285717 ;
	setAttr ".vh" -type "double2" 3148.2081911262803 -39778.571428571428 ;
	setAttr ".dag" no;
createNode hyperLayout -n "hyperLayout1";
	setAttr ".ihi" 0;
	setAttr -s 32 ".hyp";
	setAttr ".hyp[0].x" 615.71429443359375;
	setAttr ".hyp[0].y" -41627.14453125;
	setAttr ".hyp[0].nvs" 1744;
	setAttr ".hyp[1].x" 878.5714111328125;
	setAttr ".hyp[1].y" -42604.28515625;
	setAttr ".hyp[1].nvs" 1760;
	setAttr ".hyp[2].x" 610;
	setAttr ".hyp[2].y" -39835.71484375;
	setAttr ".hyp[2].nvs" 1872;
	setAttr ".hyp[3].x" 605.71429443359375;
	setAttr ".hyp[3].y" -41301.4296875;
	setAttr ".hyp[3].nvs" 1984;
	setAttr ".hyp[4].x" 600;
	setAttr ".hyp[4].y" -40650;
	setAttr ".hyp[4].nvs" 2112;
	setAttr ".hyp[5].x" 295.71429443359375;
	setAttr ".hyp[5].y" -41301.4296875;
	setAttr ".hyp[5].nvs" 1936;
	setAttr ".hyp[6].x" 604.28570556640625;
	setAttr ".hyp[6].y" -40812.85546875;
	setAttr ".hyp[6].nvs" 2016;
	setAttr ".hyp[7].x" 608.5714111328125;
	setAttr ".hyp[7].y" -40161.4296875;
	setAttr ".hyp[7].nvs" 1920;
	setAttr ".hyp[8].x" 614.28570556640625;
	setAttr ".hyp[8].y" -40975.71484375;
	setAttr ".hyp[8].nvs" 1776;
	setAttr ".hyp[9].x" 878.5714111328125;
	setAttr ".hyp[9].y" -42115.71484375;
	setAttr ".hyp[9].nvs" 1760;
	setAttr ".hyp[10].x" 294.28570556640625;
	setAttr ".hyp[10].y" -39998.5703125;
	setAttr ".hyp[10].nvs" 1984;
	setAttr ".hyp[11].x" 291.42855834960937;
	setAttr ".hyp[11].y" -42034.28515625;
	setAttr ".hyp[11].nvs" 2048;
	setAttr ".hyp[12].x" 604.28570556640625;
	setAttr ".hyp[12].y" -41790;
	setAttr ".hyp[12].nvs" 2000;
	setAttr ".hyp[13].x" 602.85711669921875;
	setAttr ".hyp[13].y" -39998.5703125;
	setAttr ".hyp[13].nvs" 2032;
	setAttr ".hyp[14].x" 292.85714721679687;
	setAttr ".hyp[14].y" -42604.28515625;
	setAttr ".hyp[14].nvs" 2000;
	setAttr ".hyp[15].x" 878.5714111328125;
	setAttr ".hyp[15].y" -39998.5703125;
	setAttr ".hyp[15].nvs" 1760;
	setAttr ".hyp[16].x" 618.5714111328125;
	setAttr ".hyp[16].y" -41464.28515625;
	setAttr ".hyp[16].nvs" 1696;
	setAttr ".hyp[17].x" 605.71429443359375;
	setAttr ".hyp[17].y" -40487.14453125;
	setAttr ".hyp[17].nvs" 1968;
	setAttr ".hyp[18].x" 600;
	setAttr ".hyp[18].y" -42115.71484375;
	setAttr ".hyp[18].nvs" 2096;
	setAttr ".hyp[19].x" 610;
	setAttr ".hyp[19].y" -42278.5703125;
	setAttr ".hyp[19].nvs" 1872;
	setAttr ".hyp[20].x" 610;
	setAttr ".hyp[20].y" -42767.14453125;
	setAttr ".hyp[20].nvs" 1888;
	setAttr ".hyp[21].x" 878.5714111328125;
	setAttr ".hyp[21].y" -41220;
	setAttr ".hyp[21].nvs" 1760;
	setAttr ".hyp[22].x" 614.28570556640625;
	setAttr ".hyp[22].y" -41138.5703125;
	setAttr ".hyp[22].nvs" 1776;
	setAttr ".hyp[23].x" 878.5714111328125;
	setAttr ".hyp[23].y" -41382.85546875;
	setAttr ".hyp[23].nvs" 1760;
	setAttr ".hyp[24].x" 1.4285714626312256;
	setAttr ".hyp[24].y" -41220;
	setAttr ".hyp[24].nvs" 1648;
	setAttr ".hyp[25].x" 610;
	setAttr ".hyp[25].y" -40324.28515625;
	setAttr ".hyp[25].nvs" 1888;
	setAttr ".hyp[26].x" 878.5714111328125;
	setAttr ".hyp[26].y" -40650;
	setAttr ".hyp[26].nvs" 1760;
	setAttr ".hyp[27].x" 301.42855834960937;
	setAttr ".hyp[27].y" -39835.71484375;
	setAttr ".hyp[27].nvs" 1808;
	setAttr ".hyp[28].x" 602.85711669921875;
	setAttr ".hyp[28].y" -42604.28515625;
	setAttr ".hyp[28].nvs" 2048;
	setAttr ".hyp[29].x" 607.14288330078125;
	setAttr ".hyp[29].y" -41952.85546875;
	setAttr ".hyp[29].nvs" 1952;
	setAttr ".hyp[30].x" 290;
	setAttr ".hyp[30].y" -40568.5703125;
	setAttr ".hyp[30].nvs" 2064;
	setAttr ".hyp[31].x" 607.14288330078125;
	setAttr ".hyp[31].y" -42441.4296875;
	setAttr ".hyp[31].nvs" 1936;
	setAttr ".anf" yes;
...
connectAttr "Head_Ctrl.msg" "hyperLayout1.hyp[0].dn";
connectAttr "ikHandle6.msg" "hyperLayout1.hyp[1].dn";
connectAttr "L_Foot_Ctrl.msg" "hyperLayout1.hyp[2].dn";
connectAttr "SpineSupport.msg" "hyperLayout1.hyp[3].dn";
connectAttr "R_ArmSupport.msg" "hyperLayout1.hyp[4].dn";
connectAttr "SpineSystem.msg" "hyperLayout1.hyp[5].dn";
connectAttr "R_Elbow_Ctrl.msg" "hyperLayout1.hyp[6].dn";
connectAttr "L_Knee_Ctrl.msg" "hyperLayout1.hyp[7].dn";
connectAttr "Chest_Ctrl.msg" "hyperLayout1.hyp[8].dn";
connectAttr "ikHandle1.msg" "hyperLayout1.hyp[9].dn";
connectAttr "L_LegSystem.msg" "hyperLayout1.hyp[10].dn";
connectAttr "L_ArmSystem.msg" "hyperLayout1.hyp[11].dn";
connectAttr "L_Elbow_Ctrl.msg" "hyperLayout1.hyp[12].dn";
connectAttr "L_LegSupport.msg" "hyperLayout1.hyp[13].dn";
connectAttr "R_LegSystem.msg" "hyperLayout1.hyp[14].dn";
connectAttr "ikHandle5.msg" "hyperLayout1.hyp[15].dn";
connectAttr "Hips_Ctrl.msg" "hyperLayout1.hyp[16].dn";
connectAttr "R_Wrist_Ctrl.msg" "hyperLayout1.hyp[17].dn";
connectAttr "L_ArmSupport.msg" "hyperLayout1.hyp[18].dn";
connectAttr "L_Clav_Ctrl.msg" "hyperLayout1.hyp[19].dn";
connectAttr "R_Foot_Ctrl.msg" "hyperLayout1.hyp[20].dn";
connectAttr "ikHandle4.msg" "hyperLayout1.hyp[21].dn";
connectAttr "COG__Ctrl.msg" "hyperLayout1.hyp[22].dn";
connectAttr "ikHandle3.msg" "hyperLayout1.hyp[23].dn";
connectAttr "RED_Rig.msg" "hyperLayout1.hyp[24].dn";
connectAttr "R_Clav_Ctrl.msg" "hyperLayout1.hyp[25].dn";
connectAttr "ikHandle2.msg" "hyperLayout1.hyp[26].dn";
connectAttr "World_Ctrl.msg" "hyperLayout1.hyp[27].dn";
connectAttr "R_LegSupport.msg" "hyperLayout1.hyp[28].dn";
connectAttr "L_Wrist_Ctrl.msg" "hyperLayout1.hyp[29].dn";
connectAttr "R_ArmSystem.msg" "hyperLayout1.hyp[30].dn";
connectAttr "R_Knee_Ctrl.msg" "hyperLayout1.hyp[31].dn";
